...
"""
Figure 4e for PulseBat-combo.

35Ah LFP combinational-pulse MAE versus normalized I sqrt(t) in selected excitation
...
SOURCE_CSV = Path(r"E:\Datasets\PulseBat_combo\Figure4\Figure4d\Figure4d_combo_pulse_mae_vs_soc.csv")
FIG_W_CM = 7.02
FIG_H_CM = 3.77
DPI = 600
CAPACITY = "LFP 35Ah"
    ...
    with path.open("r", encoding="utf-8-sig", newline="") as f:
        ...
        for row in reader:
            ...
            records.append(MaeRecord(
                ...
                soc=int(row["soc_%"]),
                group=row.get("group", row.get("crate", "")),
...
def plot(records: Sequence[MaeRecord], out_dir: Path, fig_w_cm: float, fig_h_cm: float, dpi: int) -> None:
    ...
    fig.text(0.500, 0.060, r"Combinational pulse excitation range indicated by $I\sqrt{t}$", ha="center", va="center", fontsize=7)
