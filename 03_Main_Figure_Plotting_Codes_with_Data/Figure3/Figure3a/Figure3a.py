...
"""
Figure 3a for PulseBat-combo.

20Ah LFP combo-pulse linear-model MAE versus SOC.
...
def write_mae_csv(records: Sequence[MaeRecord], out_dir: Path) -> None:
    out_csv = out_dir / "Figure3a_linear_combo_mae_vs_soc.csv"
...
def plot(records: Sequence[MaeRecord], out_dir: Path, fig_w_cm: float, fig_h_cm: float, dpi: int) -> None:
    ...
    png_path = out_dir / "Figure3a.png"
    pdf_path = out_dir / "Figure3a.pdf"
...
def plot_colorbar(out_dir: Path, dpi: int) -> None:
    ...
    png_path = out_dir / "Figure3a_colorbar.png"
    pdf_path = out_dir / "Figure3a_colorbar.pdf"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Draw PulseBat-combo Figure3a.")
    ...
    if results_root.exists():
        ...
        records = load_cached_records(out_dir / "Figure3a_linear_combo_mae_vs_soc.csv")
