...
source_folder = 'D:/BaiduSyncdisk/实验数据集合/力景数据代码上传/' + 'RawData All/' + cap_mat + '/'
# Replace according to your file path !!!
# Create the folder manually in advance !!!
save_folder = 'D:/BaiduSyncdisk/实验数据集合/力景数据代码上传/' + 'ProcessingData All/' + 'step_1_extract workstep sheet/' + cap_mat + '/'
