...
"""
Figure 3d for PulseBat-combo.

68Ah LFP contour maps of the difference in MAE between combinational-pulse
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Draw PulseBat-combo Figure3d contour panel.")
